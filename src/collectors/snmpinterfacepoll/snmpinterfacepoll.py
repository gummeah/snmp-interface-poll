...
collector called SNMPInterfaceDiscoveryCollector. The SNMPInterfaceDiscoveryCollector
...
class SNMPInterfacePollCollector(parent_SNMPCollector):
    ...
    def parse_oids_file(self, oidFilename):
        ...
        try:
            ...
            self.log.info(oidFilename, "doesn't exist, wait for SNMPInterfaceDiscoveryCollector to run first.")
